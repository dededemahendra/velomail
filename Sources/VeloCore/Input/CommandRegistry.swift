...
public struct CommandRegistry: Equatable, Sendable {
    ...
    public static let v1 = CommandRegistry(commands: [
        ...
        Command(title: "Sync now", action: .syncNow),
        Command(title: "Select all", action: .selectAll),
        Command(title: "Mark all as read", action: .markAllRead),
        Command(title: "Report spam", action: .reportSpam),
        Command(title: "Open in Gmail", action: .openInGmail),
        Command(title: "Export thread", action: .exportThread),
        ...
        Command(title: "Send at\u{2026}", action: .sendAtTime),
        ...
        Command(title: "Snooze until\u{2026}", action: .snoozeAtTime),
